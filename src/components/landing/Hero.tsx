...
export function Hero() {
  return (
    <section className="relative overflow-hidden px-6 pb-24 pt-20 sm:px-10 sm:pt-28">
      ...
      <div className="pointer-events-none absolute -bottom-16 -right-16 top-auto h-56 w-56 sm:-right-20 sm:top-0 sm:bottom-auto sm:h-[560px] sm:w-[560px]">
        <div className="absolute -inset-10 bg-[radial-gradient(closest-side,rgba(185,255,75,0.4),rgba(185,255,75,0)_72%)] sm:-inset-32" />
        <motion.div
